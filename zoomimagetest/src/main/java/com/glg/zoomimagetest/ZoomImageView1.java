...
public class ZoomImageView1 extends View {
        ...
        if (sourceBitmap != null) {
            ...
            if (bitmapWidth > width || bitmapHeight > height) {
                if (bitmapWidth - width > bitmapHeight - height) {
                    ...
                    startMatrix.postScale(ratio, ratio);
                    matrix.postScale(ratio, ratio);
                    float translateY = (height - (bitmapHeight * ratio)) / 2f;
                    // 在纵坐标方向上进行偏移，以保证图片居中显示
                    startMatrix.postTranslate(0, translateY);
                    ...
                    startMatrix.postTranslate(translateX, 0);
                ...
                startMatrix.postTranslate(translateX, translateY);
                matrix.postTranslate(translateX, translateY);
                totalTranslateX = translateX;
                totalTranslateY = translateY;
    ...
    private void reDraw(Canvas canvas) {
        canvas.drawBitmap(sourceBitmap, startMatrix, null);
    }
}
